...
public class RegularExpression {
    /**
     * @param checkInput, this method takes the String input and checks whether the
     *        specified conditions applies to it or not
     */
    public String checkPattern(String checkInput) {
        if (Pattern.matches("^[A-Z].*[.]$", checkInput)) { // checks whether the string passed matches the required
                                                           // pattern or not
